...
extension UIView {
    ...
    func pinToTopWithConstant(_ constant: CGFloat = 0) {
        guard let superview = superview else { return }
        topAnchor.constraint(equalTo: superview.topAnchor, constant: constant).isActive = true
    }

    func pinToBottomWithConstant(_ constant: CGFloat) {
        guard let superview = superview else { return }
        bottomAnchor.constraint(equalTo: superview.bottomAnchor, constant: -constant).isActive = true
    }

    func pinToLeadingWithConstant(_ constant: CGFloat) {
        guard let superview = superview else { return }
        leadingAnchor.constraint(equalTo: superview.leadingAnchor, constant: constant).isActive = true
    }

    func pinToTrailingWithConstant(_ constant: CGFloat) {
        guard let superview = superview else { return }
